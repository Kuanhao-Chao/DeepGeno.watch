...
abstract:
  Motivation RNA-small molecule binding site prediction is crucial for targeted drug discovery. Sequence-based methods
...
hook:
  GRASSP combines RNA language model representations with adaptive gated graph attention to accurately predict RNA-small
...
architecture:
  overview:
    "GRASSP: RNA Language Model-Enhanced Graph Attention with Adaptive Gating for RNA-Small Molecule Binding Site
