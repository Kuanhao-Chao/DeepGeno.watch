...
abstract: Tokens serve as the basic units of representation in DNA language models (DNALMs), yet their design remains underexplored.
...
hook: EvoLen introduces evolution-guided tokenization for DNA language models, constructing tokens based on evolutionary conservation
...
evidence:
  ...
  - id: e1
    ...
    locator:
      ...
      paragraph: 1
coreProblem:
  statement: Byte-pair encoding (BPE) ignores natural evolutionary boundaries and conservation constraints in DNA sequences
    [E0001].
  evidenceIds:
  - e1
novelty:
...
- statement: Maintains regulatory motif integrity across variable conservation strata [E0001].
  ...
  - e1
architecture:
  overview: 'EvoLen: Evolution-Guided Tokenization for DNA Language Model introduces Evolution-aware DNA foundation model
...
- claim: Achieves state-of-the-art performance in dna-language-model [E0001].
  ...
  - e1
takeaways:
- statement: Outperforms frequency-based tokenizers on promoter identification, epigenetic mark prediction, and variant impact
    [E0001].
  evidenceIds:
  - e1
limitations:
