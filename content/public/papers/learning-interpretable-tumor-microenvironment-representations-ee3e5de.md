...
abstract: In the tumor microenvironment, cell's state is influenced by cell-cell interactions (CCIs) with neighboring cells
...
hook: Models pan-cancer cell state-niche correlations to learn interpretable representations of the tumor microenvironment
...
evidence:
  ...
  - id: e1
    ...
    locator:
      ...
      paragraph: 1
coreProblem:
  statement: Tumor heterogeneity and complex cell-cell interactions in spatial niches resist interpretable computational modeling
    [E0001].
  evidenceIds:
  - e1
novelty:
...
- statement: Deconvolution of immunosuppressive versus immune-infiltrated microenvironments [E0001].
  ...
  - e1
architecture:
  overview: Learning Interpretable Tumor Microenvironment Representations by Fitting Pan-Cancer Cell State-Niche Correlation
